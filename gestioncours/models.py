...
class Salle(models.Model):
        nom_salle = models.CharField(max_length=40,default='')
        def __str__(self):
...
class Cours(models.Model):
    ...
    filiere = models.ForeignKey(Filiere, on_delete=models.CASCADE,blank='true')
    seance = models.TimeField(max_length=150,null=True)
    date = models.DateField(max_length=150,null=True)
...
class Examen(models.Model):
    ...
    date = models.DateField(max_length=150,null=True)
    def __str__(self):
        return self.matiere.nom_matiere
...
class Emploi(models.Model):
    ...
    cours_type = models.CharField(max_length=20, choices=type, null=True,blank='True')
